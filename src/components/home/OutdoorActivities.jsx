...
const OutdoorActivities = () => {
  const features = [
    ...
    },
    {
      ...
      text: "Relax in spacious rooms with large beds, cozy mattresses, and soft cotton sheets",
    },
    {
      icon: (
        <svg
      ...
      text: "Enjoy 24/7 room service including housekeeping, laundry, food delivery, and coffee on request.",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-[#ae7d54] text-xs sm:text-sm uppercase tracking-wide flex items-center gap-2 sm:gap-3">
                <img src={design} alt="Decoration" className=" " />
            ...
            <motion.h2
              className="text-3xl sm:text-4xl md:text-[42px] lg:text-5xl leading-tight font-medium font-playfair text-gray-900 mb-5 sm:mb-7 text-center lg:text-left"
            ...
            <motion.p
              className="text-gray-600 text-base sm:text-lg leading-relaxed mb-7 sm:mb-9 text-center lg:text-left max-w-2xl mx-auto lg:mx-0"
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="space-y-5 sm:space-y-6 mb-8 sm:mb-10">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="flex-shrink-0 pt-1 text-[#ae7d54]">
                    {feature.icon}
                  </div>
            ...
            >
              <Link to="/about" className="inline-block">
                <Button
                  size="lg"
                  className="bg-[#ae7d54] hover:bg-[#9a6d48] text-white px-8 py-3 sm:px-10 sm:py-4 text-sm sm:text-base"
                >
                  DISCOVER MORE
                </Button>
              </Link>
